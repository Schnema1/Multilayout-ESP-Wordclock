...
file_object = open('UHR114_Front_CH_DotoExtraBold.svg', 'w', encoding='utf-8')

startX = 239.5
startY = 1129
spacing_x = 63
spacing_y = 69.9213
# Font configuration - easily customizable
textSize = 50  # Change this value to adjust font size
fontFamily = "Doto"  # choose your font. Any you have installed. 
fontWeight = "ExtraBold"      # Explicit weight
...
for row_num, row_text in enumerate(text_rows):
    for col_num, char in enumerate(row_text):
       ...
       xml:space="preserve"
       style="font-style:normal;font-weight:{fontWeight};font-size:{textSize}px;font-family:{fontFamily};letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none"
